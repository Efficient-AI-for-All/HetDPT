"""checkpoint accuracy evaluation.
...
from hetdpt import models
from hetdpt import models_pruned
from hetdpt import utils
import re
from hetdpt.merge_mlp import merge_mlp_model, swap_activation
 
                
def get_args_parser():
    parser = argparse.ArgumentParser('HetDPT checkpoint accuracy evaluation', add_help=False)
    ...
    parser.set_defaults(repeated_aug=True)  # Set this to True for DeiT-Base.
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser('HetDPT checkpoint accuracy evaluation', parents=[get_args_parser()])
