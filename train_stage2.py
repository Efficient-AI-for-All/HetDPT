...
def get_args_parser():
    parser = argparse.ArgumentParser('HetDPT stage 2 HetDPT fine-tuning', add_help=False)
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser('HetDPT stage 2 HetDPT fine-tuning', parents=[get_args_parser()])
